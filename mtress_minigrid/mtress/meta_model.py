...
class MetaModel:
    def __init__(self, **kwargs):
        ...
        # PV
        if 'pv' in kwargs:
            if kwargs['pv']['nominal_power'] == 0:
                nominal_power = None
            elif kwargs['pv']['nominal_power'] > 0:
                nominal_power = kwargs['pv']['nominal_power']
            else:
                print("Invalid nominal power value. Exiting...")
                sys.exit(1)
            pv = kwargs.pop('pv')
